...
import { DailyOpsSummary } from './components/daily-ops-summary'
...
export function Component() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Row 2: Daily Ops (wide) + Fuel Status (narrow, stacked vertically) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-4">
          <div className="space-y-2">
            ...
            <DailyMacroCards dailyMacros={dailyMacros} macroTargets={macroTargets ?? null} vertical />
          </div>
        </div>
      </div>

      {/* Row 3: Weight Entries (narrow) + Mission Summary (wide) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <div className="lg:col-span-5">
          <div className="bg-surface-container-low h-full">
        ...
        <div className="lg:col-span-7">
          {mission && checkpoints ? (
            ...
            <div className="bg-surface-container p-8 text-center space-y-3 h-full flex flex-col items-center justify-center">
      ...
      {/* Row 4: Mission Tracker — full width deep dive */}
      {mission && checkpoints && (
